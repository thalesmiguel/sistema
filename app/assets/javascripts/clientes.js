$(document).on('ready', () => {
  ...
  $(document).on("dblclick", "#clientes-table tr[id^=cliente]", (e) => {
  ...
  $(document).on("click", "a[href='#cliente-pesquisar']", () => {
  ...
  $(document).on("click", "a[href='#cliente-visualizar'], a[href='#cliente-alertas'], a[href='#cliente-contatos'], a[href='#cliente-relatorios']", () => {
    $("#cliente-dados-adicionais").removeClass("hide");
  });
});

function altera_mascara_cpf_cnpj(){
  $("#cliente_pessoa_tipo").on("change", () => {
